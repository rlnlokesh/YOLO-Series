...
classNames = []
classFile = r"C:\Users\KENNY NISANTH\Downloads\coco.names"
with open(classFile, 'rt') as f:
    classNames = f.read().rstrip('\n').split('\n')

# Load the pre-trained model
configPath = r"C:\Users\KENNY NISANTH\Downloads\ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"
weightsPath = r"C:\Users\KENNY NISANTH\Downloads\frozen_inference_graph.pb"
